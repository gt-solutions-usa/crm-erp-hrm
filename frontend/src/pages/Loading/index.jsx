          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center relative -top-[200px]">
              ...
              <div className="flex gap-4">
                <button
                  className="py-2 px-5 text-black bg-lime-400 rounded-xl text-base cursor-pointer hover:text-black"
    ...
    <div className="bg-black w-screen h-screen flex items-center justify-center">
      ...
      <div className="flex gap-16">
        <div className="w-[10rem] h-[7rem] bg-sky-400 rounded-md flex items-center justify-center">
          <Link
            to="/erp"
            className="w-[9.25rem] h-[6.25rem] hover:text-white bg-purple-950 flex items-center justify-center text-white text-2xl font-bold"
          >
            CRM
          </Link>
        </div>
